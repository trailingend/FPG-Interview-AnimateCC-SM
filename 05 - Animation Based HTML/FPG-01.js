...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{bg:0});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(117));
